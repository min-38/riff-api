...
// 비밀번호 재설정 이메일 템플릿 (URL 링크 기반)
public class ResetPasswordLinkEmailTemplate : IEmailTemplate
{
    private readonly string _resetUrl;

    public string Subject => "비밀번호 재설정 - Riff";

    public ResetPasswordLinkEmailTemplate(string resetUrl)
    {
        _resetUrl = resetUrl;
    }
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p class='message'>
                            안녕하세요, Riff입니다.<br>
                            비밀번호 재설정 요청을 받았습니다.<br><br>
                            아래 버튼을 클릭하여 새로운 비밀번호를 설정해주세요.
                        </p>

                        <div class='button-container'>
                            <a href='{_resetUrl}' class='verify-button'>비밀번호 재설정하기</a>
                        </div>

                        <div class='info-box'>
                            <div class='info-item'>
                                <span class='info-icon'>•</span>
                                <span>이 재설정 링크는 24시간 동안만 유효합니다.</span>
                            </div>
                            <div class='info-item'>
                                <span class='info-icon'>•</span>
                            ...
                            <div class='info-item'>
                                <span class='info-icon'>•</span>
                                <span>본인이 요청하지 않았다면 이 메일을 무시하세요.</span>
                            </div>
                            <div class='info-item'>
                                <span class='info-icon'>•</span>
                        ...
                        <div class='url-fallback'>
                            ...
                            <a href='{_resetUrl}' class='url-link'>{_resetUrl}</a>
                        </div>
                    </div>
